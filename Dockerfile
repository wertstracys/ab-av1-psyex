...
RUN wget -q https://github.com/alexheretic/ab-av1/releases/download/v0.10.0/ab-av1-v0.10.0-x86_64-unknown-linux-musl.tar.zst && tar -xvf *zst && cp ab-av1 /usr/bin && rm -rf ab-av1*
